...
public class CarControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool brakeInput = Input.GetButton("Brake"); // Check for the brake input
        ...
        foreach (var wheel in wheels)
        {
            ...
            if (brakeInput)
            {
                // If the brake button is pressed, apply maximum brake torque
            ...
            {
                // If the user is trying to go in the opposite direction, apply brakes
